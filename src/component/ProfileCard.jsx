const ProfileCard = ({ data }) => {
    ...
    return (
        <div className="card-body lg:max-h-[500px] rounded-xl pb-10 pt-10">
            ...
            <div className="details flex-col sm:flex-col lg:flex-row flex m-auto w-[90%] lg:gap-4 sm:gap-0 pt-5">
                ...
                <div className="div-right inline-block mr-2 py-8 w-[48%] border text-xl px-2 rounded border-gray-100">
                    <h3 className="flex flex-col lg:flex-row justify-between" ><span>Phone</span>       <span className="font-light">{phone}</span> </h3>
                    <h3 className="flex flex-col lg:flex-row justify-between" ><span>Email</span>       <span className="font-light"> {email}</span> </h3>
                    <h3 className="flex flex-col lg:flex-row  justify-between" ><span>Address</span>     <span className="font-light"> {street}</span> </h3>
